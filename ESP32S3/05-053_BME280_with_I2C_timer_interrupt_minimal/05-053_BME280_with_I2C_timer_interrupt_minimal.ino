...
bool initializeTimer() {
    ...
    // Configure alarm value for periodic interrupts
    timerAlarmWrite(timer, TIMER_ALARM_VALUE, TIMER_AUTO_RELOAD);
    
    // Start the timer
    timerAlarmEnable(timer);
    
    Serial.printf("✓ Timer %d initialized successfully\n", TIMER_NUMBER);
    Serial.printf("  Prescaler: %d (1MHz tick rate)\n", TIMER_PRESCALER);
